...
<noscript>
	<img height="1" width="1" alt="" style="display: none" src="https://www.facebook.com/offsite_event.php?id=6009930053200&amp;value=0&amp;currency=USD" />
</noscript>
...
<jsp:body>
    <section class="container middle">
        ...
        <ul id="collection" class="related-books">
            ...
            <li class="col-right">
                <a href="/products/livro-certificacao-java-associate"
                   class="block clearfix book-suggest"
            ...
            <li class="col-left">
                <a href="/products/livro-sql-oracle"
                   class="block clearfix book-suggest"
                   data-book="SQL: Uma abordagem para bancos de dados Oracle"> 
                        <img width="113px" 
                             height="160px"
            ...
            <li class="col-right">
                <a href="/products/livro-orientacao-objetos-java"
                   class="block clearfix book-suggest"
